...
public class GuiRenderer {
    ...
    public static IGuiOverlay overlay = ((gui, guiGraphics, partialTick, screenWidth, screenHeight) -> {
        ...
        guiGraphics.blit(WIDGETS,xPos + 29, yPos - 23, 24, 22, 29, 24);
        RenderSystem.enableBlend();
        RenderSystem.defaultBlendFunc();

        guiGraphics.renderItem(stack,xPos + 32, yPos - 19);
    });
}
